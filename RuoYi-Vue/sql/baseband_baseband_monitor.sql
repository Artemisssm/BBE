...
VALUES
-- 调制单元
('MODULATE','MOD_SCHEME','调制体制','ENUM','{"0":"BPSK","1":"QPSK","2":"OQPSK","3":"8PSK","4":"16QAM","5":"GMSK"}',NULL,NULL,1,8,10,'0','枚举：0=BPSK',NOW()),
...
('MODULATE','ROLL_OFF','滚降系数','ENUM','{"0":"0.20","1":"0.25","2":"0.35","3":"0.50"}',NULL,NULL,1,4,40,'2','0:0.20 1:0.25 2:0.35 3:0.50',NOW()),
...
('MODULATE','CLOCK_SOURCE','时钟源','ENUM','{"0":"内部晶振","1":"外部10MHz","2":"GPSDO"}',NULL,NULL,1,2,80,'0','0=内部 1=外部 2=GPSDO',NOW()),
('MODULATE','PA_ENABLE','功放使能','SWITCH',NULL,NULL,NULL,1,1,90,'0','0关 1开',NOW()),
-- 编码单元
('ENCODE','FEC_TYPE','编码方案','ENUM','{"0":"卷积","1":"Turbo","2":"LDPC","3":"RS","4":"BCH"}',NULL,NULL,1,4,10,'0','0=卷积 1=Turbo 2=LDPC等',NOW()),
('ENCODE','CODE_RATE','码率','ENUM','{"0":"1/2","1":"2/3","2":"3/4","3":"5/6","4":"7/8"}',NULL,NULL,1,4,20,'0','常用码率',NOW()),
('ENCODE','CONSTRAINT_LEN','约束长度','UINT',NULL,3,15,1,8,30,'7','卷积编码K值',NOW()),
('ENCODE','INTERLEAVER','交织方式','ENUM','{"0":"不交织","1":"块交织","2":"卷积交织","3":"伪随机"}',NULL,NULL,1,4,40,'0','交织策略',NOW()),
...
('ENCODE','CRC_POLY','CRC多项式','ENUM','{"0":"CRC16","1":"CRC24","2":"CRC32"}',NULL,NULL,1,2,70,'0','0=CRC16等',NOW()),
('ENCODE','SCRAMBLE_POLY','扰码多项式','ENUM','{"0":"x^7+x^1+1","1":"x^9+x^5+1","2":"x^15+x^14+1"}',NULL,NULL,1,2,80,'0','扰码配置',NOW()),
('ENCODE','TEST_PATTERN','测试序列','ENUM','{"0":"关闭","1":"PRBS7","2":"PRBS15","3":"固定字"}',NULL,NULL,1,2,90,'0','测试/回环模式',NOW()),
-- 解调单元
('DEMODULATE','DEMOD_SCHEME','解调体制','ENUM','{"0":"BPSK","1":"QPSK","2":"OQPSK","3":"8PSK","4":"16QAM","5":"自动"}',NULL,NULL,1,4,10,'5','5=自动识别',NOW()),
...
-- 译码单元
('DECODE','DECODER_MODE','译码模式','ENUM','{"0":"Viterbi","1":"Turbo","2":"LDPC","3":"RS","4":"BCH"}',NULL,NULL,1,4,10,'0','对应编码方案',NOW()),
...
('DECODE','OUTPUT_FORMAT','输出帧格式','ENUM','{"0":"裸Payload","1":"含帧头","2":"含时间戳"}',NULL,NULL,1,2,60,'1','0/1/2',NOW()),
('DECODE','STAT_WINDOW','误码统计窗口(帧)','UINT',NULL,10,10000,1,16,70,'100','FER/BER窗口',NOW()),
('DECODE','BYPASS_MODE','旁路模式','ENUM','{"0":"正常译码","1":"译码前回环","2":"译码后直通"}',NULL,NULL,1,2,80,'0','调试使用',NOW());
